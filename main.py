    ...
    steps:
      ...
      - name: Install Android SDK
        run: |
          ...
          $ANDROID_HOME/cmdline-tools/latest/bin/sdkmanager "platform-tools" "platforms;android-34" "build-tools;34.0.0" "build-tools;36.0.0"
      ...
      - name: Build with Buildozer
        run: |
          export PATH="$PATH:~/.local/bin:$ANDROID_HOME/build-tools/36.0.0"
